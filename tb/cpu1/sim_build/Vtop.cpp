...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__holy_test_harness__DOT__axi{vlSymsp->TOP.__PVT__holy_test_harness__DOT__axi}
    , __PVT__holy_test_harness__DOT__core__DOT__m_axi_instr{vlSymsp->TOP.__PVT__holy_test_harness__DOT__core__DOT__m_axi_instr}
    , __PVT__holy_test_harness__DOT__core__DOT__m_axi_data{vlSymsp->TOP.__PVT__holy_test_harness__DOT__core__DOT__m_axi_data}
    , rootp{&(vlSymsp->TOP)}
{
