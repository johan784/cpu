...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+2,0,"reset_n",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+4,0,"data_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->pushPrefix("logic1", VerilatedTracePrefixType::SCOPE_MODULE);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelfRef.reset_n));
    bufp->fullBit(oldp+3,(vlSelfRef.data_in));
    bufp->fullBit(oldp+4,(vlSelfRef.data_out));
    bufp->fullBit(oldp+5,(vlSelfRef.logic1__DOT__clk));
    bufp->fullBit(oldp+6,(vlSelfRef.logic1__DOT__reset_n));
    bufp->fullBit(oldp+7,(vlSelfRef.logic1__DOT__data_in));
    bufp->fullBit(oldp+8,(vlSelfRef.logic1__DOT__data_out));
}
