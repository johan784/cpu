...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.alu__DOT__s1 = vlSelfRef.s1;
    vlSelfRef.alu__DOT__s2 = vlSelfRef.s2;
    vlSelfRef.alu__DOT__alu_result = ((4U & (IData)(vlSelfRef.alu__DOT__alu_control))
                                       ? ((2U & (IData)(vlSelfRef.alu__DOT__alu_control))
                                           ? 0U : (
                                                   (1U 
                                                    & (IData)(vlSelfRef.alu__DOT__alu_control))
                                                    ? 
                                                   VL_LTS_III(32, vlSelfRef.alu__DOT__s1, vlSelfRef.alu__DOT__s2)
                                                    : 0U))
                                       : ((2U & (IData)(vlSelfRef.alu__DOT__alu_control))
                                           ? ((1U & (IData)(vlSelfRef.alu__DOT__alu_control))
                                               ? (vlSelfRef.alu__DOT__s1 
                                                  | vlSelfRef.alu__DOT__s2)
                                               : (vlSelfRef.alu__DOT__s1 
                                                  & vlSelfRef.alu__DOT__s2))
                                           : ((1U & (IData)(vlSelfRef.alu__DOT__alu_control))
                                               ? 0U
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/Users/johananil/Desktop/cpu/logic1/alu.sv", 1, "", "Input combinational region did not converge after 100 tries");
        }
